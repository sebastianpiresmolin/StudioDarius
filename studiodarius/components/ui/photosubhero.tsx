export default function Photosubhero() {
    return (
        <div>
            <div className="flex md:flex-row flex-col w-full items-center mt-8 2xl:mt-36 bg-[#DEE5ED] lg:pt-12 lg:pb-12 xl:pt-18 xl:pb-18 2xl:pt-36 2xl:pb-36">
                <div className="flex-col md:w-1/2 items-center">
                    ...
                    <h1 className="text-[#6B4D38] font-sans text-3xl lg:text-3xl 2xl:text-4xl font-thin mb-4 min-w-full md:w-3/4 text-center">
                        Här för att fånga eran <span className="font-serif text-3xl lg:text-3xl xl:text-4xl 2xl:text-5xl">lycka</span>
                    </h1>
