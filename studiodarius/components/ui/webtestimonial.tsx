...
export default function Webtestimonial() {
    return (<div className="w-full flex flex-col m-auto mt-36">
            <div className="m-auto font-sans font-thin text-7xl">
                Låt oss ta eran verksamhet till <span className="font-serif">nästa nivå</span>
            </div>
            <div className="m-auto font-sans font-thin text-5xl text-center mt-10">
                Ta inte vårat ord för det,<br/><span className="font-serif">ta deras.</span>
            </div>
            <Image className="m-auto mt-5" src={"/line.png"} alt={"seperator line"} width={500} height={5}/>
            <div className="m-auto font-sans text-center font-thin text-3xl max-w-[750px] mt-10">“Att arbeta med
            ...
            <div className="flex flex-col text-center mt-10">
                <h3 className="font-sans font-black text-xl">Alan Hussein</h3>
                <h3 className="font-sans text-stone-800 font-thin text-md">Grundare & CEO @Tempura Tabby</h3>
            </div>
        </div>);
}