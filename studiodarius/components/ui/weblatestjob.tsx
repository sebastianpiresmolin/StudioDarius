...
export default function Weblatestjob() {
    return (
            <div className="flex flex-col w-full items-center mt-16 lg:mt-36">
                ...
                <div className="flex flex-col-reverse xl:flex-row md:w-2/3 xl:w-full xl:max-w-[1280px] pl-2 pr-2 lg:pl-0 lg:pr-0 items-center justify-evenly lg:mt-10 mt-4 gap-2">
