...
export default function Photoprices() {
    return (
        <div className="w-full flex flex-col lg:pl-12 lg:pr-12 mt-10 xl:mt-18">
            ...
            <div className="mt-10 gap-5 flex flex-col xl:flex-row justify-between text-white">
                <div className="bg-[url('/photooffercard1.png')] bg-cover w-[95%] h-[660px] flex flex-col rounded-2xl m-auto">
                    <div className="flex justify-between p-5 items-center">
                        <h3 className="font-sans text-sm md:text-xl xl:text-lg">Bröllop & Evemenemang</h3>
                ...
                <div className="bg-[url('/photooffercard2.png')] w-[95%] h-[660px] bg-cover flex flex-col rounded-2xl m-auto">
                    <div className="flex justify-between p-5">
                        <h3 className="font-sans text-sm md:text-xl xl:text-lg">Barn & Familj</h3>
                        <h3 className="font-sans text-xs font-bold md:text-xl xl:text-sm">Från 250kr/t *</h3>
                    </div>
                    <div className="flex justify-center">
                        <p className="font-sans font-light text-sm text-center pl-2 pr-2 md:text-lg lg:text-xl xl:text-lg 2xl:text-xl xl:pl-2 xl:pr-2">För dig som vill bevara stunderna som går förbi alldeles för fort.</p>
                    </div>
                    <ul className="mt-5 ml-5 pl-2 pr-2">
                        <li className="flex items-center font-sans font-light text-sm lg:text-lg 2xl:text-xl mt-2">
                ...
                <div className="bg-[url('/photooffercard3.png')] w-[95%] h-[660px] bg-cover flex flex-col rounded-2xl m-auto">
                    <div className="flex justify-between p-5">
                        <h3 className="font-sans text-sm md:text-xl xl:text-lg">Djur</h3>
                        <h3 className="font-sans text-xs font-bold md:text-xl xl:text-sm">Från 250kr/t *</h3>
                    </div>
                    <div className="flex justify-center">
                        <p className="font-sans font-light text-sm text-center pr-2 pl-2 md:text-lg lg:text-xl 2xl:text-xl xl:pl-2 xl:pr-2">För dig som vill fånga ditt djurs hjärta – inte bara dess päls</p>
                    </div>
                    <div className="flex justify-center">
                        <p className="font-sans font-light text-sm text-center md:text-lg pr-2 pl-2 2xl:text-xl xl:pl-2 xl:pr-2 mt-2">Obs: Det går ej att garantera resultat inom låsta timmar då djur har ett eget liv! Fundera på ifall ni kan vara flexibla i hur länge fotograferingen kan pågå.
                        </p>
                    </div>
                    <ul className="mt-5 ml-5 pl-2 pr-2 ">
                        <li className="flex items-center font-sans font-light text-sm lg:text-lg  2xl:text-xl mt-2">
            ...
            <p className="flex items-center m-auto gap-2 mt-4 font-sans text-md pl-4 pr-4 text-center">
